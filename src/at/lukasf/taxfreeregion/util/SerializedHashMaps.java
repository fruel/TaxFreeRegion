...
public class SerializedHashMaps implements Serializable {
	...
	public SerializedHashMaps(HashMap<PlayerRegion, SavedInventory> inventories, HashMap<PlayerRegion, Double> healthValues, HashMap<PlayerRegion, IntFloat> xpValues, HashMap<PlayerRegion, IntFloat> hungerValues) {
